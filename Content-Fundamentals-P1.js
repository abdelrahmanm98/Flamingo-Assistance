...
const FundamentalsP1_1 = `<section class="charts mt-4">
<div class="chart-container p-3 "style="padding: 0.3rem !important">
 
  <div class="divttyprint">
  <h3 class="Description-H3" style="">Linking a JavaSript File</h3>
...
/////////////////////////////////////////
const FundamentalsP1_3 = `<section class="charts mt-4">
<div class="chart-container p-3 "style="padding: 0.3rem !important">
  
  <div class="divttyprint">
  <h3 class="Description-H3">Quick Description</h3>
  <P class="Description-P" dir=rtl>
...
const FP1_File = document.querySelector(".section__-1");
FP1_File.insertAdjacentHTML("afterbegin", FundamentalsP1_1);

// Fundamentals Part 1 Linking a File
const Values_andVariables = document.querySelector(".section__-2");
Values_andVariables.insertAdjacentHTML("afterbegin", FundamentalsP1_2);

// Fundamentals Part 1 Data_Types
const FP1Data_Types = document.querySelector(".section__-3");

FP1Data_Types.insertAdjacentHTML("afterbegin", FundamentalsP1_3);
